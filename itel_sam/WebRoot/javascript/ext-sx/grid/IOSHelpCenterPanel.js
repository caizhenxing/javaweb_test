function IOSHelpCenterPanel(o) {
	...
	var connection = new Ext.data.Connection( {
		url : Ext.ctx + '/samHelpCenterController/queryForWhereAnd?fields[type]=IOS',
		method : 'GET',
		defaultHeaders : {
			'Accept' : 'application/json'
		},
				...
				items : [ {
					...
					store : new Ext.data.JsonStore({
						...
						proxy : new Ext.data.HttpProxy({
							url :Ext.ctx+'/samUpgradeController/getVersionAllByType/IOS',
							defaultHeaders : {
								'Accept' : 'application/json'
							},
							method : 'GET'
